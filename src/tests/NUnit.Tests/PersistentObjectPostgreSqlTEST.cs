...
namespace tests
{
    ...
    [TestFixture]
    public class PersistentObjectPostgreSqlTEST
    {
        ...
        public void Init()
        {
            ...
            cpo = new CategoryPersistentObject(DatabaseServer.PostgreSql, SharedData.postgresql, ctm);

            firstTable = new First();
            firstPersistent = new FirstPersistentObject(DatabaseServer.PostgreSql, SharedData.postgresql, firstTable);
        ...
        public void TestCreateSimple()
        {
           ...
           // byte[] file = System.IO.File.ReadAllBytes(SharedData.LARGE_BLOB_FILE_PATH);
