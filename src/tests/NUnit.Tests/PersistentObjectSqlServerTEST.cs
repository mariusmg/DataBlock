...
namespace tests
{
    ...
    [TestFixture]
    public class PersistentObjectSqlServerTEST
    {
        ...
        public void Init()
        {
            ...
            cpo = new CategoryPersistentObject(DatabaseServer.SqlServer, SharedData.sqlserver, ctm);

            firstTable = new First();
            firstPersistent = new FirstPersistentObject(DatabaseServer.SqlServer, SharedData.sqlserver, firstTable);
