<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Authors.aspx.vb" Inherits="Authors" Title="Authors" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="gridViewAuthors" runat="server" AllowPaging="True" AutoGenerateColumns="False"
        ...
        CellPadding="3" Height="157px" OnRowCommand="New_RowCommand" Width="240px">
