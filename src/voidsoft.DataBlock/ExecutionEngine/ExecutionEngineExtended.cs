...
namespace voidsoft.DataBlock
{
	...
	public partial class ExecutionEngine
	{
		...
		/// <returns></returns>
		public object ExecuteScalar(DatabaseServer database, string connectionString, ExecutionQuery query)
		{
		...
		public DataSet ExecuteDataSet(DatabaseServer edt, string connectionString, string storedProcedure, params IDataParameter[] iparam)
		{
			DbConnection icon = null;
			DbCommand icmd = null;
			DataSet dset = null;
		...
		public void ExecuteDataSet(DatabaseServer edt, string connectionString, ExecutionQuery executableQuery, ref DataSet ds)
		{
			DbConnection icon = null;
			DbCommand icmd = null;
			DbDataAdapter idap = null;
