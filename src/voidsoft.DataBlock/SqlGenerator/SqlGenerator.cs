...
namespace voidsoft.DataBlock
{
	...
	public class SqlGenerator
	{
		...
		//fields used for thread syncronization
		private static object syncDeleteObject = new object();

		private static object syncUpdateObject = new object();

		private static object syncInsertObject = new object();
		...
		public static ExecutionQuery GenerateSelectQuery(DatabaseServer database, QueryCriteria criteria)
		{
			...
			for (int i = 0; i < criteria.JoinCriteriaConditions.Length; i++)
			{
				...
				{
					sqlBuilder.Append(GetTableName(DatabaseServer.PostgreSql, criteria.JoinCriteriaConditions[i].Criteria.TableName) + "." +
					                  criteria.JoinCriteriaConditions[i].Criteria.Fields[j].fieldName);
		...
		public static ExecutionQuery GenerateSelectQuery(DatabaseServer database, TableMetadata mainTable, bool generateConditionByPrimaryKey)
		{
		...
		[MethodImpl(MethodImplOptions.Synchronized)]
		public static ExecutionQuery GenerateSelectQuery(DatabaseServer database, string tableName, DatabaseField[] fields, bool generateConditionByPrimaryKey)
		{
			ISqlGenerator isql = null;
			...
			try
			{
				...
				if (generateConditionByPrimaryKey)
				{
					...
					for (int i = 0; i < fields.Length; i++)
					{
						if (fields[i].isPrimaryKey)
						{
							IDataParameter param = DataConvertor.ConvertToDataParameter(database, GetTableName(database, tableName), fields[i]);
		...
		/// <returns>Returns the SELECT query</returns>
		public static ExecutionQuery GenerateSelectQuery(DatabaseServer database, TableMetadata mainTable, params DatabaseField[] conditionalFields)
		{
		...
		/// <returns>Returns the SELECT query</returns>
		[MethodImpl(MethodImplOptions.Synchronized)]
		public static ExecutionQuery GenerateSelectQuery(DatabaseServer database, string tableName, DatabaseField[] fields, params DatabaseField[] conditionalFields)
		{
			ISqlGenerator isql = null;
			...
			try
			{
				...
				else
				{
					...
					if (conditionalFields != null)
					{
						...
						{
							IDataParameter param = DataConvertor.ConvertToDataParameter(database, tableName, conditionalFields[i]);
		...
		/// <returns>Returns the SELECT query</returns>
		[MethodImpl(MethodImplOptions.Synchronized)]
		public static ExecutionQuery GenerateSelectQuery(DatabaseServer database, string tableName, params DatabaseField[] conditionalFields)
		{
			ISqlGenerator isql = null;
			ExecutionQuery execQuery;
			List<IDataParameter> listParameters = null;
		...
		/// <returns></returns>
		[MethodImpl(MethodImplOptions.Synchronized)]
		public static ExecutionQuery GenerateSelectPaginatedQuery(DatabaseServer database, TableMetadata metadata, int numberOfItems, int pageNumber)
		{
		...
		public static ExecutionQuery GenerateInsertQuery(DatabaseServer database, DatabaseField[] fields, string tableName)
		{
			ISqlGenerator isql = null;
					...
					for (int i = 0; i < fields.Length; i++)
					{
						...
						if (i == fields.Length - 1)
						{
							...
							else
							{
								...
								IDataParameter[] iparams = DataConvertor.ConvertToDataParameter(database, fields[i]);
		...
		/// <returns>The generated query</returns>
		public static ExecutionQuery GenerateInsertQuery(DatabaseServer database, TableMetadata entity)
		{
		...
		public static ExecutionQuery GenerateDeleteQuery(DatabaseServer database, TableMetadata table, bool generateConditionOnlyByPrimaryKey)
		{
			ISqlGenerator isql = null;
			StringBuilder sbuild = null;
			ExecutionQuery execQuery;
				...
				else
				{
					...
					lock (syncDeleteObject)
					{
						...
						for (int i = 0; i < table.TableFields.Length; i++)
						{
							...
							{
								IDataParameter[] parameter = DataConvertor.ConvertToDataParameter(database, table.TableFields[i]);
		...
		/// <param name="conditionalFields">DatabaseFields from which the condition is generated</param>
		/// <returns>Returns the DELETE query</returns>
		public static ExecutionQuery GenerateDeleteQuery(DatabaseServer database, TableMetadata table, params DatabaseField[] conditionalFields)
		{
		...
		/// <returns>Returns the DELETE query</returns>
		public static ExecutionQuery GenerateDeleteQuery(DatabaseServer database, string tableName, params DatabaseField[] conditionalField)
		{
			ISqlGenerator isql = null;
			...
			try
			{
				...
				lock (syncDeleteObject)
				{
					...
					if (conditionalField.Length > 0)
					{
						...
						{
							IDataParameter[] parameter = DataConvertor.ConvertToDataParameter(database, conditionalField[i]);
							listParameters.Add(parameter[0]);
		...
		public static ExecutionQuery GenerateUpdateQuery(DatabaseServer database, string tableName, DatabaseField[] fields, bool generateConditionByPrimaryKey)
		{
			ISqlGenerator isql = null;
			ExecutionQuery execQuery;
			List<IDataParameter> listParameters = null;
			...
			try
			{
				...
				lock (syncUpdateObject)
				{
					...
					for (int i = 0; i < fields.Length; i++)
					{
						...
						if (i == fields.Length - 1)
						{
							IDataParameter[] parameters = DataConvertor.ConvertToDataParameter(database, fields[i]);
							sbuild.Append(" " + fields[i].fieldName + isql.GetValueWithAttributionOperator(parameters[0]));
							listParameters.Add(parameters[0]);
						}
						else
						{
							IDataParameter[] parameter = DataConvertor.ConvertToDataParameter(database, fields[i]);
		...
		public static ExecutionQuery GenerateUpdateQuery(DatabaseServer database, TableMetadata table, bool generateConditionByPrimaryKey)
		{
		...
		/// <returns>Returns the UPDATE query</returns>
		public static ExecutionQuery GenerateUpdateQuery(DatabaseServer database, string tableName, bool skipConditionalFieldsFromUpdateList,
		                                                 DatabaseField conditionalField, params DatabaseField[] updateFields)
		{
		...
		/// <returns>Returns the UPDATE query</returns>
		public static ExecutionQuery GenerateUpdateQuery(DatabaseServer database, string tableName, bool skipConditionalFieldsFromUpdateList,
		                                                 DatabaseField[] conditionalFields, params DatabaseField[] updatedFields)
		{
			ISqlGenerator isql = null;
			ExecutionQuery execQuery;
			List<IDataParameter> listParameters = null;
			...
			try
			{
				...
				lock (syncUpdateObject)
				{
					...
					for (int i = 0; i < updatedFields.Length; i++)
					{
						...
						IDataParameter[] parameter = DataConvertor.ConvertToDataParameter(database, updatedFields[i]);
					...
					if (conditionalFields != null)
					{
						...
						for (int i = 0; i < conditionalFields.Length; i++)
						{
							IDataParameter[] parameter = DataConvertor.ConvertToDataParameter(database, conditionalFields[i]);
							listParameters.Add(parameter[0]);
		...
		public static List<ExecutionQuery> GenerateMultipleDeleteQueries(DatabaseServer database, TableMetadata table)
		{
		...
		/// <returns>List containing the queries</returns>
		[MethodImpl(MethodImplOptions.Synchronized)]
		public static List<ExecutionQuery> GenerateMultipleInsertQueries(DatabaseServer database, TableMetadata mainTable)
		{
			GraphBuilder builder = null;
			List<ExecutionQuery> listQueries = null;
		...
		/// <returns>List containing the queries</returns>
		public static List<ExecutionQuery> GenerateMultipleUpdateQueries(DatabaseServer database, TableMetadata mainTable)
		{
			List<ExecutionQuery> listQueries = null;
			GraphBuilder builder = null;
		...
		[MethodImpl(MethodImplOptions.Synchronized)]
		internal static string GetTableName(DatabaseServer database, string tableName)
		{
